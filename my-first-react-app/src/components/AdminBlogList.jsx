...
const AdminBlogList = () => {
  ...
  useEffect(() => {
    axios.get('https://backend.moviefinder-teckish.com/api/blogs/all')
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {blogs.map(blog => (
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-2">Date Created: {new Date(blog.createdAt).toLocaleString()}</p>
