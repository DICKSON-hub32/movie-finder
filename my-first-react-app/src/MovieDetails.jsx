...
const MovieDetails = () => {
  ...
  if (canonicalSlug !== slug) {
    return <Navigate to={`/movie/${canonicalSlug}`} replace />;
  }

  const description = movie.overview
    ? movie.overview
    : `Discover details, trailers, and ratings for ${movie.title}.`;
  const posterUrl = movie.poster_path
    ? `https://image.tmdb.org/t/p/w780/${movie.poster_path}`
    : "https://moviefinder-teckish.com/movie_placeholder.jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`${movie.title}, movie details, trailers, ratings, cast`}
        />
        <link
          rel="canonical"
          href={`https://moviefinder-teckish.com/movie/${canonicalSlug}`}
        />
        <meta property="og:title" content={`${movie.title} | Movie Finder`} />
        <meta property="og:description" content={description} />
        <meta
          property="og:url"
          content={`https://moviefinder-teckish.com/movie/${canonicalSlug}`}
        />
        <meta property="og:type" content="video.movie" />
        <meta property="og:image" content={posterUrl} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${movie.title} | Movie Finder`} />
