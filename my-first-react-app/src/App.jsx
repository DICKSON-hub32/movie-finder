...
const App = () => {
  ...
  return (
    <main
      className={`relative min-h-screen ${theme === "dark" ? "dark bg-black text-white" : "bg-gray-100 text-gray-900"}`}
    >
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Home | Movie Finder - Discover Trending and Popular Films"
        />
        <meta
          name="og:description"
      ...
      <div className="wrapper max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="relative">
          ...
          <section className="mt-6 text-center max-w-4xl mx-auto px-4">
            ...
            >
              Welcome to Movie Finder, your premier destination to discover a
              world of cinematic treasures. This platform is meticulously
              designed to serve as your ultimate guide to trending films,
              offering a seamless experience where movie enthusiasts can explore
              the latest releases and timeless classics. With a focus on
              delivering top-tier content, Movie Finder combines cutting-edge
              technology with a passion for cinema to bring you an unparalleled
              movie-watching journey right at your fingertips.
            </p>
            <p
              className={`text-lg mt-4 ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              Dive into an expansive collection of cinematic masterpieces as
              Movie Finder provides in-depth reviews, personalized
              recommendations, and the latest industry news to enhance your
              movie-watching experience. Whether you're seeking blockbuster hits
              or hidden gems, our curated selection ensures you stay ahead of
              the curve with trending films that captivate and inspire. This hub
              is tailored to cater to every cinephile, offering insights that
              enrich your understanding and enjoyment of the silver screen.
            </p>
            <p
              className={`text-lg mt-4 ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
            >
              Explore beyond the surface with Movie Finder, where each visit
              unveils new opportunities to engage with the world of cinema. From
              detailed analyses of upcoming movie releases to expert-curated
              lists of must-watch films, we are committed to keeping you
              informed with the latest industry news. Enhance your
              movie-watching experience with our personalized recommendations,
              designed to match your unique tastes, making Movie Finder your
              go-to resource for all things film-related.
            </p>
            <div></div>
          </section>
